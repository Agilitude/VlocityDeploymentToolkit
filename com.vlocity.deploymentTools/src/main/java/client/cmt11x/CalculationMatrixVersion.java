...
public class CalculationMatrixVersion extends VlocityArtifact {
    public CalculationMatrixVersion(ArtifactTypesEnum artifactType, String packageName, String packageVersion) {
        ...
        this.FieldDefinitions = new ArrayList<VlocityArtifactFieldDefinition>() {{
            ...
            add(new VlocityArtifact.VlocityArtifactFieldDefinition("Vlocity_Calculation_Table_Line_Items__r", "Rows", FieldTypeEnum.LIST_OF_VLOCITY_ARTIFACT, ArtifactTypesEnum.CALCULATION_MATRIX_ROW));
        }};
    }
