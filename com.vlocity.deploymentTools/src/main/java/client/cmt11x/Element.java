...
public class Element extends VlocityArtifact implements Comparable<Element> {
    ...
    public Element(ArtifactTypesEnum artifactType, String packageName, String packageVersion) {
        ...
        this.FieldDefinitions = new ArrayList<VlocityArtifact.VlocityArtifactFieldDefinition>() {{
            add(new VlocityArtifact.VlocityArtifactFieldDefinition("Id", "Id", FieldTypeEnum.STRING, false, false));
            ...
            add(new VlocityArtifact.VlocityArtifactFieldDefinition("ParentElementId__c", "ParentId", FieldTypeEnum.STRING, false, false));
            add(new VlocityArtifact.VlocityArtifactFieldDefinition("Elements__r", "ChildElements", FieldTypeEnum.LIST_OF_VLOCITY_ARTIFACT, ArtifactTypesEnum.ELEMENT));
        }};
    }
