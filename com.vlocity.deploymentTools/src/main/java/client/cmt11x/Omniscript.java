...
public class Omniscript extends VlocityArtifact {
    ...
    public Omniscript(ArtifactTypesEnum artifactType, String packageName, String packageVersion) {
        ...
        this.FieldDefinitions = new ArrayList<VlocityArtifactFieldDefinition>() {{
            ...
            add(new VlocityArtifact.VlocityArtifactFieldDefinition("Elements__r", "Elements", FieldTypeEnum.LIST_OF_VLOCITY_ARTIFACT, ArtifactTypesEnum.ELEMENT));
            add(new VlocityArtifact.VlocityArtifactFieldDefinition("OmniScriptDefinitions__r", "CompiledDefinitions", FieldTypeEnum.LIST_OF_VLOCITY_ARTIFACT, ArtifactTypesEnum.COMPILED_OUTPUT));
        }};
    }
