...
public class DataPackRequest extends com.vlocity.deploymentTools.client.DataPackRequest {
    ...
    public DataPackRequest(DataPackRequest.RequestTypeEnum requestType, String vlocityDataPackType) {
    ...
    public DataPackRequest(DataPackRequest.RequestTypeEnum requestType, String vlocityDataPackType, String vlocityDataPackDataId) {
        this.processType = requestType.name();
        this.processData = new RequestDetails();
        this.processData.VlocityDataPackType = vlocityDataPackType;
